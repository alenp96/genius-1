...
const PdfPage = () => {
    ...
    const handleSubmit = async (e:any) => {
      ...
      if (file) {
        try {
          ...
          axios
            .post("https://saas-nlpc.onrender.com/ingest/pdf", formData, {
              headers: {
                "Content-Type":
            ...
            .then((res) => {
              console.log("answer pdf", res);
                      toast({
                        title: "Pdf Ingested Succesfully.",
                        description: "The pdf file was ingested successfully.",
                        status: "success",
                        duration: 9000,
                        isClosable: true,
                      });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
          ...
          axios
            .post(
              "https://saas-nlpc.onrender.com/query/pdf",
              {
